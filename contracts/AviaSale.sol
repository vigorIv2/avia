...
/**
  Avia Smart Contract crowdsale
*/
                                                                                     
//contract AviaSale is Ownable, PausableCrowdsale(false), TokensCappedCrowdsale(1000000000000000000), RefundableCrowdsale {
contract AviaSale is Ownable, PausableCrowdsale(false), TokensCappedCrowdsale(AviaSale.TOKENS_CAP) {
...
//**********************************************************************************************
  ...
  string  public constant crowdsaleTokenName = "AVIA token";
  string  public constant crowdsaleTokenSymbol = "AVIA";
  uint256 public constant TOKENS_CAP = 15 * 10**_decimals; // sale cap in USD aka tokens with 6 dec places
  uint256 public constant tokensGoal = 6 * 10**_decimals; // sale goal in tokens with 6 decimal 
//**********************************************************************************************

  
  function AviaSale() public 
  ...
  function createTokenContract() internal returns (MintableToken) {
    AviaToken tokenLoc = new AviaToken(crowdsaleTokenName,crowdsaleTokenSymbol);
    return tokenLoc;
  }
  ...
  /**
  * @dev Sets AVIA to Ether rate. Will be called multiple times durign the crowdsale to adjsut the rate
  * since AVIA cost is fixed in USD, but USD/ETH rate is changing
